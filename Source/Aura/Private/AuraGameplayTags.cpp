...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Secondary_ArmorPenetration = UGameplayTagsManager::Get()
		.AddNativeGameplayTag(FName("Attributes.Secondary.ArmorPenatration"),
	...
	GameplayTags.Attributes_Secondary_CriticalHitChance = UGameplayTagsManager::Get()
		...
		FString("Chance to double damage plus critical hit bonous"));
	...
	*/
	...
	/*
	* Map of Damage Typs to Resistances
	*/
